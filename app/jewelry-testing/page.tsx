        ...
        <div className="w-full flex flex-col items-center justify-center">
            <div className="w-full max-w-[1200px]">
                <section className="w-full relative h-[60vw] max-h-[770px]">
                    <Image src={"/jewelry_testing.png"} alt="pro" fill className="object-cover" />
                ...
                <section className={`${raleway.className} font-bold text-[18px] text-center mt-10 lg:mt-28 px-4 lg:text-[48px]`}>
                ...
                <section className="mt-6 lg:mt-12 px-4 flex flex-wrap items-center justify-center gap-4 lg:gap-8">
                    ...
                    <div className="text-center">
                        ...
                        <div className={`${inter.className} text-[#475467] mt-2`}>
                            Not a cheap diamond pen tester. Our scanner deeply analyzes the material structure.
                        </div>
                    </div>
                    <div className="text-center">
                        <div className={`${inter.className} font-semibold`}>
                    ...
                    <div className="text-center">
                        ...
                        <div className={`${inter.className} text-[#475467] mt-2`}>
                            We&apos;ve helped individuals, collectors, and jewelers across Nigeria get the clarity they need.
                        </div>
                    </div>
                </section>
                ...
                <section className="mt-[40px] lg:mt-[80px] px-4">
                    <div className={`${raleway.className} font-bold text-center text-[18px] lg:text-[48px]`}>
                        WHY SHOULD I TEST MY JEWELRY?
                    </div>
                    <div className={`${raleway.className} mt-3 lg:mt-6 text-center lg:text-[20px]`}>
                        Every week in Lagos, people walk into our office with rings,
                        chains, or earrings they thought were gold or diamond—only
                        to discover otherwise. That’s why testing your jewelry is
                        so important.
                    </div>
                    <div className="mt-3 lg:mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div className="flex flex-col items-center gap-3 bg-[#FAFAFA] p-6 lg:p-8">
                            ...
                            <div className={`${raleway.className} text-[20px] font-medium text-center`}>
                                Check If It’s Real
                            </div>
                            <div className={`${raleway.className} font-light text-center`}>
                                Is it a natural diamond, lab diamond, moissanite,
                                or cubic zirconia? Our scan test tells you instantly.
                            </div>
                        </div>
                        <div className="flex flex-col items-center gap-3 bg-[#FAFAFA] p-6 lg:p-8">
                            ...
                            <div className={`${raleway.className} font-light text-center`}>
                                Don’t get scammed. Testing helps you avoid overpaying or
                                selling for less.
                            </div>
                        </div>
                        <div className="flex flex-col items-center gap-3 bg-[#FAFAFA] p-6 lg:p-8">
                            ...
                            <div className={`${raleway.className} font-light text-center`}>
                                If you’re insuring or reselling your jewelry, you need
                                verified proof of what it really is.
                            </div>
                        </div>
                        <div className="flex flex-col items-center gap-3 bg-[#FAFAFA] p-6 lg:p-8">
                            ...
                            <div className={`${raleway.className} font-light text-center`}>
                                ...
                                Testing available in Lagos, Accra, and Dubai. Searching
                                "where to test jewelry in Lagos"? You're in the right place.
                            </div>
                        </div>
                    </div>
                </section>
